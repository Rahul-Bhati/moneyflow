...
**Why:** Land Zod and tighten validation _before_ multi-user code touches actions — defense in depth from day one.
...
**Why:** Production hardening. Everything that's been built so far should now work great on a 360px phone _and_ a 1440px desktop, load fast, and reject malformed input gracefully.
...
2. **End-of-day "Money Minute"** push notification at user's chosen time: _"30 seconds — log today's spend?"_ Tapping opens directly into the Add sheet. Mobile-only.
...
4. **Personal records.** _"Lowest spend week ever"_, _"First month under budget"_, surfaced as banner cards.
5. **AI insights nudge.** _"You're 18% over your usual coffee spend this month. Want to set a cap?"_ One LLM call against anonymized category totals.
...
7. **Achievement badges.** _No-spend day_, _Logged 7 days straight_, _Saved ₹10k in a month_, _Logged a transaction in every category_. Badges live on a profile page; tapping shows the date earned.
8. **Themed challenges.** _Coffee-free week_, _₹100/day challenge_, _No-eat-out month_. Opt-in, with a progress bar on the dashboard.
...
10. **Anonymous benchmarks.** _"You spent less on food than 73% of people in your city this month."_ Aggregated only, never per-user.
11. **Couples / household mode.** Shared wallet view, split bills, who paid what. Many money apps under-serve this and people _pay_ for it.
12. **Accountability buddy.** Opt-in: pair with a friend who sees only your _streak_ and _savings goal progress_, not amounts.
...
15. **Forecasting.** _"At this rate you'll end the month ₹4,200 short of your savings goal."_ Simple linear projection from `chartBuckets` data.
